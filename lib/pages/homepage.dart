...
class _homepageState extends State<homepage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.blueAccent, // Set the background color to aqua blue
        title: Text(
          'Discover Projects',
          style: TextStyle(
        ...
        children: [
          ...
          Center(
            child: InkWell(
              ...
              child: Ink.image(
                image: NetworkImage('https://www.carnegiefoundation.org/wp-content/uploads/2022/03/New-Bizz-Featured-Image.png'),
                fit: BoxFit.cover,
                width: 200,
                height: 100,
              ),
